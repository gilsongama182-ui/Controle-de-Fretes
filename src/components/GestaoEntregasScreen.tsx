                ...
                <table className="w-full text-left border-separate border-spacing-0 min-w-[3240px]">
                  <thead className="bg-surface-container-low border-b border-outline-variant text-xs font-bold uppercase tracking-wider text-on-surface-variant sticky top-0">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-right sticky top-0 right-0 z-20 bg-surface-container-low shadow-[-4px_0_12px_rgba(0,0,0,0.05)]">Ações</th>
                    </tr>
                  </thead>
                    ...
                    {paginatedDeliveries.length > 0 ? (
                      paginatedDeliveries.map((del) => (
                        <tr key={del.id} className={`hover:bg-primary/5 transition-colors group ${selectedIds.has(del.id) ? 'bg-primary/5' : ''}`}>
                          ...
                          <td className="px-4 py-4 text-right sticky right-0 z-10 bg-white group-hover:bg-[#f6f8fa] transition-colors shadow-[-4px_0_12px_rgba(0,0,0,0.05)]">
